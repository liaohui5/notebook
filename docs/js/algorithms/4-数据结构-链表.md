...
![linked-list](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_a8a5e47c5bc02d8d33f57685d6cb8914.png)
 ...
 * 用抽象类实现一些公共的方法
 */
export default abstract class LinkedListAbstract<
  T,
  P extends LinkedNode<T> | DoublyLinkedNode<T>,
