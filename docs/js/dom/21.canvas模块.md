...
## 巧用 HTMLCanvasElement 实例方法

这个类除了 `getContent` 方法外, 还有其他两个方法比较实用:
...
- [toDataURL](https://developer.mozilla.org/zh-CN/docs/Web/API/HTMLCanvasElement/toDataURL) 将图片转 base64 字符串
