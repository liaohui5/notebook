...
- [也可以使用知名的开源库 ua-parser-js](https://github.com/faisalman/ua-parser-js)
...
// 可用于运行线程的逻辑处理器数量(不是实际 CPU 物理核心数)
// 比如: 14 核 20 线程, 那么获取的就是 20
const workers = navigator.hardwareConcurrency;

// 获取浏览器 UI 设置的语言信息, 多用于多语言适配
...
- [NetworkInfomation](https://developer.mozilla.org/zh-CN/docs/Web/API/NetworkInformation)

```javascript
const netInfo = navigator.connection;
const isOnline = navigator.onLine;
const isOffline = navigator.offLine;
```
