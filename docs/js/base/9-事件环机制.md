...
![](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_b283187b009aac350f8df8726de6b6ed.png)
...
[https://developer.mozilla.org/zh-CN/docs/Web/API/Window/queueMicrotask](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/queueMicrotask)
虽然 mdn 文档将这个API放到 window 对象中但这个API可以 node.js 中也是可以用的
