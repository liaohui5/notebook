...
export default {
  ...
  '/deploy/docker/': [
    ...
    {
      text: '12.部署 MySQL 等数据库',
      link: '/deploy/docker/12.mysql-server',
    },

    {
      text: '13.部署 RustDesk 服务端',
      link: '/deploy/docker/rust-desk-server',
    },

    {
      text: '14.部署 Gitlab',
      link: '/deploy/docker/gitlab-web',
    },

    {
      text: '15.部署 NginxProxyManager',
      link: '/deploy/docker/nginx-proxy-manager',
    },

    {
      text: '16.部署 ftp 服务器',
      link: '/deploy/docker/ftp-server',
      // link: 'https://hub.docker.com/r/fauria/vsftpd',
    },

    {
      text: '17.使用 docker 版 ffmpeg',
      link: '/deploy/docker/docker-ffmpeg',
    },
  ],
