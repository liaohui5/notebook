...
![get-github-token1](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_f6b1a7fb97baefb3c37f95850a9b8a5d.png)
![get-github-token2](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_ededbff27064294e5568be1102c8e2de.png)
![get-github-token3](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_8600fd411d47e5cc616bfad0f2e71e4f.png)

> [!TIP] 2.创建一个空的 GitHub 仓库, 并配置 GitHub Actions Secrets

![set-secrets1](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_8f1a9d2ced67460877c9d28146f0b476.png)
![set-secrets2](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_48107ca9dc936b91cd4fefbedda18ad1.png)
...
![1](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_c7c97cf810d92dd05eadd0e812e18550.png)
![2](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_9ab3f960e682e66fab78a2bed8ed5a0a.png)
![3](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_ad479729bb8f436b4a5bd79f2e73671b.png)

> [!TIP] 2.将获取到的 npmjs.com Token 配置到 GitHub Actions Secrets

![4](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_7971282906621b17b8242bf0b84e928f.png)
...
![preview-runner](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_9ef4b4b6fcdf40d62c164e38dbcffcc3.png)

可以看到没有问题, 已经操作成功了

![github-success](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_6bb3f1a20d6bfcedf45311c645f4b4c2.png)
![npm-success](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_562763025851cbb9dc89853b75e7f431.png)

## 7. 修改代码再次提交测试

这次不要在 `main` 分支修改代码, 而是新建一个 `next` 分支, 修改代码后在提交测试

![next-preview](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_968460f0c055cff28bed126a9d22515d.png)

提交之后, 会提示有 `pull-request` 需要合并到 `main` 分支, 点击 `Compare & pull request` 合并

![pull-request](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_efb066cc1f4f0cf62fdbbd4ac0efd1e1.png)

合并请求后,会自动触发 `release` workflow, 然后重新打 tag, 生成 changelog, 上传 assets, 发布到 npm

![](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_d3e9c2b7531f37e3fc19144e1d8b2862.png)
...
![verdaccio token](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_f0cbb33abe85dca3819bd7ffc0c811d5.png)
