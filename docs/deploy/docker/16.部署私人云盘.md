...
- [hacdias/webdav](https://github.com/hacdias/webdav) Go语言版本的 webdav 实现, 体积小, 速度快, 功能全
- [difeid/webdav-server-rs](https://github.com/difeid/webdav-server-rs) Rust 版本的 webdav-server, 速度非常快(更多功能正在开发中, 可尝鲜体验)
- [ugeek/webdav](https://hub.docker.com/r/ugeek/webdav) 基于 Nginx 的 webdav 镜像, 速度快, 支持的平台多(amd/arm/Raspberry等都支持)
...
```yaml [config.yaml]
# docs: https://github.com/hacdias/webdav
# conf: https://github.com/hacdias/webdav?tab=readme-ov-file#configuration
address: 0.0.0.0
port: 6065
tls: false
cert: cert.pem
...
users:
  - username: admin
    # original password: admin123456
    # generate password online: https://bcrypt-generator.com/
    password: "{bcrypt}$2a$12$5YOS9c7W2uHDpwCjXwa2SupqbUOft7OQNsE6q6sVAGoDni.flBndS"
    permissions: CRUD
```
