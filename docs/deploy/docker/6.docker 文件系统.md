...
![image-20200711185834204](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_180f3a6b13b900293b24a1fe2c8a587e.png)

**容器的数据持久化和同步操作, 容器与容器之间可以实现数据共享, 简单理解: 功能就类似于虚拟机的共享目录, 无论是在主机中修改文件还是在容器中修改文件, 另外一方都会自动同步, 功能效果就类似于 vue.js 的双向绑定**

![image-20200711190703516](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_8d6fc92b42fb251a31b5519c13159eb9.png)
