...
- https://liaohui5.github.io/docker-tools/#/cmd2config

功能介绍:

1. 将 `docker run xxx` 命令转为 `docker-compose.yaml` 配置文件
2. 将 `docker-compose.yaml` 配置文件转为 `docker run xxx` 命令
3. 转换 `docker-compose.yaml` 不同版本的规范写法
...
![image-20210909222609322](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_3fd9a1b6d742ffb0d0ac161e67366fb4.png)
...
![image-20210909225611416](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_997664f393722d0a4023c58fd52ab6e9.png)
...
![image-20210909231454230](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_4f4ba5c0574cb242aa25df638acf7ac0.png)

### 项目启动后, 查看 images/containers 的变化

在 `第2步` docker-compose 启动的时候, 会检查配置文件中需要用到的镜像, 如果有本地没有就会自己去下载

![image-20210909232124100](https://notebook-imgbed.s3.bitiful.net/notebook-imgbed/2026_06_18_7042622372239c028ccd40f9cfefc046.png)
